  ...
  return (
    <>
      <footer className="w-full">
        <div className="w-full max-w-screen-2xl py-4 md:py-8 xl:py-12 mx-auto flex flex-col justify-center items-center gap-2 md:gap-4 lg:gap-6 bg-background brightness-125">
          <div className="flex gap-2 md:gap-4 lg:gap-6 justify-center items-center">
            ...
            >
              ...
              <svg
                className="fill-gray-500 h-4 w-4 md:h-6 md:w-6 lg:h-8 lg:w-8 hover:fill-gray-300 transition-all"
            ...
            >
              ...
              <svg
                className="fill-gray-500 h-3 w-3 md:h-5 md:w-5 lg:h-7 lg:w-7 hover:fill-gray-300 transition-all"
