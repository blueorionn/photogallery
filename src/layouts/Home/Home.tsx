  ...
  return (
    <>
      <section className="w-full max-w-screen-2xl relative mx-auto my-6 md:my-12 xl:my-24 xl:flex xl:flex-row-reverse xl:justify-between">
        ...
        <section className="w-full h-64 sm:h-96 md:h-[28rem] lg:h-[32rem] xl:h-max absolute top-[60%] xl:top-0 xl:relative z-[50]">
          ...
          <div className="max-w-screen-md w-full relative z-[50] my-4 md:my-6 xl:my-8 px-4 xl:px-0">
            ...
            <h3
              className={`my-4 md:my-6 xl:my-8 text-base xl:text-xl font-normal cursor-default text-gray-600 dark:text-gray-400`}
            >
          ...
          <div className="my-4 md:my-8 xl:my-12 flex items-center gap-2 lg:gap-4 relative z-[50] px-4 xl:px-0">
            <div className="group">
              <Link
                href={"/gallery"}
                target="_blank"
                className="py-2 lg:py-4 w-36 lg:w-40 xl:w-44 flex justify-center items-center gap-2 rounded-full bg-teal-600 dark:bg-teal-700 group-hover:bg-transparent border-2 border-teal-600 dark:border-teal-700 transition-all"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 -960 960 960"
                  className="h-6 w-6 fill-gray-300 group-hover:fill-gray-400 transition-all"
                >
                ...
                <span className="text-gray-300 group-hover:text-gray-400 dark:text-gray-300 group-hover:dark:text-gray-400 text-sm lg:text-base">
                  Gallery
                </span>
              </Link>
            </div>
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 -960 960 960"
                className="h-6 w-6 fill-gray-400 group-hover:fill-gray-500 dark:group-hover:fill-gray-200 transition-all"
              >
              ...
              <span className="text-sm lg:text-base text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-200 transition-all">
                Collections
              </span>
            </Link>
          </div>
      ...
      <section className="w-full max-w-screen-2xl mx-auto relative my-40 sm:my-44 md:my-48">
        <h2
          className={`${ubuntu.className} px-4 xl:px-0 text-lg md:text-xl lg:text-2xl xl:text-3xl cursor-default text-gray-600 dark:text-gray-400`}
        >
          Discover
        </h2>
