...
export default function Collections() {
  ...
  return (
    <>
      ...
      >
        {frozen ? (
          <span className="min-w-16 md:min-w-24 xl:min-w-36 inline-block h-0.5 bg-gray-400 dark:bg-gray-700"></span>
        ) : (
          ""
        )}
        {frozen ? (
          <span className="text-gray-400 dark:text-gray-500 font-medium text-base xl:text-lg text-nowrap whitespace-nowrap">
